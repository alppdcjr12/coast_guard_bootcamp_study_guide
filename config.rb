...
PHONETIC_FOCUS_ARGS = {
  ...
  # no need to compile with essential as this is done by the function that adds phonetic questions
  "ESSENTIAL_PHONETIC_SAMPLE" => RANDOM_PHONETIC_RATES_AND_RANKS_QUESTIONS,
}
